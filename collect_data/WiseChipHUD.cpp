...
void WiseChipHUD::AdjustIconLevel(uint16_t IconNo, uint16_t IconLevel)
{
  uint16_t Temp;
  uint16_t Temp_I;
...
uint16_t WiseChipHUD::ChangeRedValue(uint16_t OriginalValue , uint16_t R_Value)
{
  uint16_t Temp;
...
uint16_t WiseChipHUD::ChangeGreenValue(uint16_t OriginalValue, uint16_t G_Value)
{
  uint16_t Temp;
...
uint16_t WiseChipHUD::ChangeBlueValue(uint16_t OriginalValue, uint16_t B_Value)
{
  uint16_t Temp;
...
uint16_t WiseChipHUD::ChangeRG_Value(uint16_t OriginalValue, uint16_t RG_Value)
{
  uint16_t Temp;
...
uint16_t WiseChipHUD::ChangeGB_Value(uint16_t OriginalValue, uint16_t GB_Value)
{
  uint16_t Temp;
...
uint16_t WiseChipHUD::SetRGB_Value(uint16_t RGB_Value)
{
  uint16_t Temp;
...
void WiseChipHUD::NumericalTo4BCD(uint16_t S_Number, uint8_t *BCD_Ptr)
{
  uint8_t i;
  uint16_t Quotient;
  uint16_t QuotienNav;
...
//=======================================================================================================
void WiseChipHUD::D01(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(0, IconData[0].Level);
  }
  else
  {
    AdjustIconLevel(0, 0x00);
  }
}

void WiseChipHUD::CC1(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(1, IconData[1].Level);
  }
  else
  {
    AdjustIconLevel(1, 0x00);
  }
}

void WiseChipHUD::D02(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(2, IconData[2].Level);
  }
  else
  {
    AdjustIconLevel(2, 0x00);
  }
}

void WiseChipHUD::CC2(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(3, IconData[3].Level);
  }
  else
  {
    AdjustIconLevel(3, 0x00);
  }
}

void WiseChipHUD::D03(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(4, IconData[4].Level);
  }
  else
  {
    AdjustIconLevel(4, 0x00);
  }
}

void WiseChipHUD::CC3(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(5, IconData[5].Level);
  }
  else
  {
    AdjustIconLevel(5, 0x00);
  }
}

void WiseChipHUD::D04(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(9, IconData[9].Level);
  }
  else
  {
    AdjustIconLevel(9, 0x00);
  }
}

void WiseChipHUD::CC4(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(8, IconData[8].Level);
  }
  else
  {
    AdjustIconLevel(8, 0x00);
  }
}

void WiseChipHUD::D05(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(18, IconData[18].Level);
  }
  else
  {
    AdjustIconLevel(18, 0x00);
  }
}

void WiseChipHUD::CC5(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(17, IconData[17].Level);
  }
  else
  {
    AdjustIconLevel(17, 0x00);
  }
}

void WiseChipHUD::D06(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(26, IconData[26].Level);
  }
  else
  {
    AdjustIconLevel(26, 0x00);
  }
}

void WiseChipHUD::CC6(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(27, IconData[27].Level);
  }
  else
  {
    AdjustIconLevel(27, 0x00);
  }
}

void WiseChipHUD::D07(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(29, IconData[29].Level);
  }
  else
  {
    AdjustIconLevel(29, 0x00);
  }
}

void WiseChipHUD::CC7(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(28, IconData[28].Level);
  }
  else
  {
    AdjustIconLevel(28, 0x00);
  }
}

void WiseChipHUD::D08(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(31, IconData[31].Level);
  }
  else
  {
    AdjustIconLevel(31, 0x00);
  }
}

void WiseChipHUD::CC8(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(30, IconData[30].Level);
  }
  else
  {
    AdjustIconLevel(30, 0x00);
  }
}

void WiseChipHUD::compassCircle(uint8_t Select) //0-9 00-full off 1-8 => specify which CCx goes off 9-all bright 10-17=> specifies which CCx is on (inverse with 1-8)
{
  switch (Select)
  {
    case 0:
...
void WiseChipHUD::D0x(uint8_t Action)
{
  if (Action)
  {
    D01(1);
...
void WiseChipHUD::compassArrows(uint8_t Select)   //0-9 00-full off 1-8 => specify which one is off D0x 9-all bright 10-17=> specify which one D0x is on (inverse with 1-8)
{
  switch (Select)
  {
    case 0:
...
void WiseChipHUD::radarDistanceUnits(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(80, IconData[80].Level);
  }
  else
  {
    AdjustIconLevel(80, 0x00);
  }
}

void WiseChipHUD::flag(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(32, IconData[32].Level);
  }
  else
  {
    AdjustIconLevel(32, 0x00);
  }
}

void WiseChipHUD::C01(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(40, IconData[40].Level);
  }
  else
  {
    AdjustIconLevel(40, 0x00);
  }
}

void WiseChipHUD::C02(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(48, IconData[48].Level);
  }
  else
  {
    AdjustIconLevel(48, 0x00);
  }
}

void WiseChipHUD::H01(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(58, IconData[58].Level);
  }
  else
  {
    AdjustIconLevel(58, 0x00);
  }
}

void WiseChipHUD::K01(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(56, IconData[56].Level);
  }
  else
  {
    AdjustIconLevel(56, 0x00);
  }
}

void WiseChipHUD::M01(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(57, IconData[57].Level);
  }
  else
  {
    AdjustIconLevel(57, 0x00);
  }
}

void WiseChipHUD::C03(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(145, IconData[145].Level);
  }
  else
  {
    AdjustIconLevel(145, 0x00);
  }
}

void WiseChipHUD::K02(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(153, IconData[153].Level);
  }
  else
  {
    AdjustIconLevel(153, 0x00);
  }
}

void WiseChipHUD::M03(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(154, IconData[154].Level);
  }
  else
  {
    AdjustIconLevel(154, 0x00);
  }
}

void WiseChipHUD::P01(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(211, IconData[211].Level);
  }
  else
  {
    AdjustIconLevel(211, 0x00);
  }
}

void WiseChipHUD::P02(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(212, IconData[212].Level);
  }
  else
  {
    AdjustIconLevel(212, 0x00);
  }
}

void WiseChipHUD::P03(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(213, IconData[213].Level);
  }
  else
  {
    AdjustIconLevel(213, 0x00);
  }
}

void WiseChipHUD::T01(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(189, IconData[189].Level);
  }
  else
  {
    AdjustIconLevel(189, 0x00);
  }
}

void WiseChipHUD::T02(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(197, IconData[197].Level);
  }
  else
  {
    AdjustIconLevel(197, 0x00);
  }
}

void WiseChipHUD::tirePressureAlert(uint8_t Action){
...
void WiseChipHUD::speedometerUnits(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(230, IconData[230].Level);
  }
  else
  {
    AdjustIconLevel(230, 0x00);
  }
}

void WiseChipHUD::destinationDistanceUnits(uint8_t iconUnits){
...
void WiseChipHUD::turnDistanceUnits(uint8_t iconUnits){
...
void WiseChipHUD::leftTunnel(uint8_t Action)
{
  if (Action)
  {
...
void WiseChipHUD::middleTunnel(uint8_t Action)
{
  if (Action)
  {
...
void WiseChipHUD::rightTunnel(uint8_t Action)
{
  if (Action)
  {
...
void WiseChipHUD::leftRoad(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(91, IconData[91].Level);
...
void WiseChipHUD::middleRoad(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(90, IconData[90].Level);
...
void WiseChipHUD::rightRoad(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(200, IconData[200].Level);
...
void WiseChipHUD::nav_Group(uint8_t Action)
{
  uint8_t i;
...
void WiseChipHUD::nav_KeepLeft(uint8_t Action)
{
...
void WiseChipHUD::nav_TurnLeft(uint8_t Action)
{
...
void WiseChipHUD::nav_TurnRight(uint8_t Action)
{
...
void WiseChipHUD::nav_HardRight(uint8_t Action)
{
...
void WiseChipHUD::nav_HardLeft(uint8_t Action)
{
...
void WiseChipHUD::nav_UTurnLeft(uint8_t Action)
{
...
void WiseChipHUD::nav_UTurnRight(uint8_t Action)
{
...
void WiseChipHUD::nav_ContinueStraight(uint8_t Action)
{
  //  uint8_t i;
...
void WiseChipHUD::nav_KeepRight(uint8_t Action)
{
  //  uint8_t i;
...
void WiseChipHUD::S01_BAR(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(6, IconData[6].Level);  //S01_1
    AdjustIconLevel(7, IconData[7].Level);  //S01_2
  }
  else
  {
    AdjustIconLevel(6, 0x00); //S01_1
    AdjustIconLevel(7, 0x00); //S01_2
  }
}

void WiseChipHUD::S15_BAR(uint8_t Action)
{
  if (Action)
  {
    AdjustIconLevel(215, IconData[215].Level);  //S15_1
    AdjustIconLevel(214, IconData[214].Level);  //S15_2
  }
  else
  {
    AdjustIconLevel(215, 0x00); //S15_1
    AdjustIconLevel(214, 0x00); //S15_2
  }
}

void WiseChipHUD::radarDetector(uint8_t Level)  //00-08     00-全滅  01-主體  02-08 =>Level
{
  switch (Level)
  {
    case 0:
...
void WiseChipHUD::DispNumber(const uint16_t *SegIconPtr, uint8_t DispNo)
{
  uint8_t Cnt;
  uint16_t tmp;
  uint32_t DispData;
...
void WiseChipHUD::setHeading(uint8_t SpeedNo)
{
  uint8_t BCDcode[4];
...
void WiseChipHUD::setDestinationDistance(uint16_t SpeedNo, uint8_t Mode)
{
  uint8_t BCDcode[4];
...
void WiseChipHUD::setRadarDistance(uint16_t SpeedNo, uint8_t Mode)
{
  uint8_t BCDcode[4];
...
void WiseChipHUD::setTurnDistance(uint16_t SpeedNo, uint8_t Mode)
{
  uint8_t BCDcode[4];
...
void WiseChipHUD::setTirePressure(uint8_t SpeedNo, uint8_t Mode)
{
  uint8_t BCDcode[4];
...
void WiseChipHUD::setSpeedometer(uint8_t SpeedNo)
{
  uint8_t BCDcode[4];
...
void WiseChipHUD::setCallIcon(uint8_t iconStatus){
...
void WiseChipHUD::SoftReset(unsigned char DriverNo)
{
  ReceiveData[0] = 0x01;  //SoftReset Command No.
  IIC_Write_Command1(IIC_Addr[DriverNo], 1, ReceiveData);
}

void WiseChipHUD::SetOscControl(unsigned char DriverNo, unsigned char mode)
{
...
void WiseChipHUD::SetGraphicsRAMWritingDirection(unsigned char DriverNo, unsigned char mode)
{
...
void WiseChipHUD::SetInterface(unsigned char DriverNo, unsigned char mode)
{
...
void WiseChipHUD::DisplayOnOff(unsigned char DriverNo, unsigned char Val)
{
...
void WiseChipHUD::DisplayStandbyOnOff(unsigned char DriverNo, unsigned char Val)
{
...
void WiseChipHUD::SetDisplaySize(unsigned char DriverNo, unsigned char Xstart, unsigned char Xend, unsigned char Ystart, unsigned char Yend)
{
...
void WiseChipHUD::SetDotCurrent(unsigned char DriverNo, unsigned char Rlevel, unsigned char Glevel, unsigned char Blevel)
{
...
void WiseChipHUD::SetSystemClockDivisionRatio(unsigned char DriverNo, unsigned char mode)
{
...
void WiseChipHUD::SetPreChargeWidth(unsigned char DriverNo, unsigned char Val)
{
...
void WiseChipHUD::SetPeakPulseWidth(unsigned char DriverNo, unsigned char Rlevel, unsigned char Glevel, unsigned char Blevel)
{
...
void WiseChipHUD::SetPeakPulseDelay(unsigned char DriverNo, unsigned char Val)
{
...
void WiseChipHUD::SetRowScanOperation(unsigned char DriverNo, unsigned char mode)
{
...
void WiseChipHUD::SetInternalRegulatorforRowScan(unsigned char DriverNo, unsigned char mode)
{
...
void WiseChipHUD::DumpDataToDriver(unsigned char DriverNo, unsigned int SData)
{
...
void WiseChipHUD::initializeHUD231(void)
{
  uint8_t i, j;
...
void WiseChipHUD::IIC_Write_Command1(uint8_t IIC_Addr, uint16_t DataLen, uint8_t *DataPtr)
{
  uint16_t Cnt;
...
void WiseChipHUD::IIC_Write_Data1(uint8_t IIC_Addr , uint16_t DataLen, uint8_t *DataPtr)
{
  uint16_t Cnt;
...
void WiseChipHUD::IIC_Write_Data2(uint8_t IIC_Addr , uint16_t DataLen, const uint8_t *DataPtr)
{
  uint16_t Cnt;
  uint8_t   tmp;
...
//---------------------------------ALL ON-----------------------------------//
void WiseChipHUD::allOn(void)
{
  clearAll(); // Clears all of the segments

  compassCircle(9);
  compassArrows(9);
  setHeading(188);
  radarDetector(8);
  setRadarDistance(888, 0);
  radarDistanceUnits(1);
  flag(1);
  setDestinationDistance(888, 2);
  destinationDistanceUnits(3);
  H01(1);
  leftTunnel(1);
  middleTunnel(1);
  rightTunnel(1);
  nav_Group(1);
  setTurnDistance(888, 1);
  turnDistanceUnits(2);
  setCallIcon(3);
  tirePressureAlert(3);
